        ...
        <Stack
          ...
          <Stack flex={1} spacing={{ base: 5, md: 10 }}>
            ...
            <Text color={'gray.500'}    align={'center'}>
              Hackathon Board shows you the latest and hottest hackathons across Zimbabwe and abroad.
              Most of these hackathons are open for everyone to participate and win!.
            </Text>
            <Stack
               align={'center'} >

                {/* Should link to hackathon page or section  */}
              <Button
                rounded={'full'}
                size={'lg'}
                fontWeight={'normal'}
